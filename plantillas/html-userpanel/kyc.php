...
<head>
	...
	<!-- Site Title  -->
	<title>KYC Application | User Center - ICO Crypto</title>
	<!-- Vendor Bundle CSS -->
                            ...
                            <div class="tab-pane fade show active" id="personal-data">
                                <form action="#">
                                    <div class="input-item input-with-label">
                                        ...
                                        <input class="input-bordered" type="text" id="title" name="title">
                                    </div>
                                    <div class="input-item input-with-label">
                                        <label for="request" class="input-item-label">Your request</label>
                                        <input class="input-bordered" type="text" id="request" name="request">
                                    </div>
                                    <div class="row">
