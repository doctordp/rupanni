 ...
 -->                        <ul class="btn-grp guttar-10px"><!-- 
                ...
                <div class="user-content">
                    <div class="user-panel">
                        ...
                        <h5>Comming Soon!</h5>
                        <h3>You will be able to invite your friends for benefits in covidtrade</h3>
                        <div class="refferal-info">
                            <span class="refferal-copy-feedback copy-feedback"></span>
                            <em class="fas fa-link"></em>
                            <input type="text" class="refferal-address" value="https://discord.com/invite/U7NNrHh" disabled>
                            <button class="refferal-copy copy-clipboard" data-clipboard-text="https://discord.com/invite/U7NNrHh"><em class="ti ti-files"></em></button>
                        </div>
